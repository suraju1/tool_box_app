                    ...
                    builder: (context, snapshot) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // In a real app, you'd fetch the other user's profile here or store their name in the chat_room doc
                          final otherUserName =
                              "User $otherUserId"; // Placeholder

                          return _buildChatItem(
                            context,
                            docs[index].id, // Pass chatRoomId
                            otherUserName, // Use placeholder name or fetch it
                            text,
                            timeString,
                            unreadCountStr,
